 ...
 */
@NoArgsConstructor
public class SqlServerConfig extends BaseDBConfig {
    ...
    public SqlServerConfig(String host, String port, String user, String password, String initDataBase) {
    ...
    public String getUrl() {
        return String.format(Constant.SQL_SERVER_URL,this.getHost(),this.getPort(),this.getInitDataBase());
    }
}
