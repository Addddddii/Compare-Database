...
@Slf4j
@FXMLController
public class MySqlConfigLeftController {
    ...
    public void doConnection(){
        try {
            ...
            List<String> databaseNameList = databaseStructureLoader.loadAllDatabaseNames(Constant.LEFT, DataBaseEnum.MySql.getType());
