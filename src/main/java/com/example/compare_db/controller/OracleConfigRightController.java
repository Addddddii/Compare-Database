...
@Slf4j
@FXMLController
public class OracleConfigRightController implements Initializable {
    ...
    public void doConnection() {
        try {
            ...
            List<String> databaseNameList = databaseStructureLoader.loadAllDatabaseNames(Constant.RIGHT, DataBaseEnum.Oracle.getType());
